                        ...
                        <fieldset>
                            ...
                            if (isset($_POST['table'])) {
                                foreach ($_POST['table'] as $table) {
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="textinput_' . $tablename . '-' . $i . '"name="' . $tablename . 'columns[' . $i . '][columndisplay]" type="text" placeholder="Display field name in frontend" class="form-control rounded-0">
                                    </div>
                                    <div class="col-md-4">
                                        <input class="form-check-input" type="checkbox" name="' . $tablename . 'columns[' . $i . '][columnvisible]" id="checkboxes-' . $checked_tables_counter . '-' . $i . '" value="1">
                                <label class="form-check-label" for="checkboxes-' . $checked_tables_counter . '-' . $i . '">Visible in overview?</label></div>
                     </div>';
                                            $i++;
                                        }
                            ...
                            <div class="row py-3">
                                ...
                                <div class="d-grid py-2">
                                    <button type="submit" id="singlebutton" name="singlebutton" class="btn btn-outline-success rounded shadow-sm">Generate Pages</button>
                                </div>
                            </div>
                        </fieldset>
                    </form>
